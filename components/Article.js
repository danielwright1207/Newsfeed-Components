...
function articleMaker(art) {
  ...
  article.textContent = art.article;
  articleTitle.textContent = art.title;
  articleDate.textContent = art.date;
...
data.forEach((element) => {
  let newArticle = articleMaker(element);
  articles1.appendChild(newArticle);
});
/*
  <div class="article">
...
articles1.appendChild(articleMaker(addArticle));
